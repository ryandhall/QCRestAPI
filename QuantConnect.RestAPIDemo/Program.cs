...
namespace QuantConnect.RestAPIDemo
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            int newProjectId = api.ProjectCreate("New Test Project");
            Console.WriteLine("New Project Id: " + newProjectId);
            ...
            bool updateSuccess = api.ProjectUpdate(newProjectId, files);
            Console.WriteLine("Updated project: " + updateSuccess.ToString());

            Console.WriteLine("==========================================");
            Console.WriteLine("Test 4: List Project Contents:");
            var projectFiles = api.ProjectFiles(newProjectId);
            foreach (File file in projectFiles)
            {
            ...
            bool deleteSuccess = api.ProjectDelete(newProjectId);
            Console.WriteLine("Deleted project: " + deleteSuccess.ToString());
